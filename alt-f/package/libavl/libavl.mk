...
$(TARGET_DIR)/$(LIBAVL_TARGET_LIBRARY): $(LIBAVL_DIR)/$(LIBAVL_TARGET)
	...
	ln -srf $(TARGET_DIR)/$(LIBAVL_TARGET_LIBRARY) $(TARGET_DIR)/$(LIBAVL_DESTDIR)/libavl.so.1
	ln -srf $(TARGET_DIR)/$(LIBAVL_TARGET_LIBRARY) $(TARGET_DIR)/$(LIBAVL_DESTDIR)/libavl.so
	#
	cp $(LIBAVL_DIR)/$(LIBAVL_TARGET) $(STAGING_DIR)/$(LIBAVL_DESTDIR)
	ln -srf $(STAGING_DIR)/$(LIBAVL_TARGET_LIBRARY) $(STAGING_DIR)/$(LIBAVL_DESTDIR)/libavl.so.1
	ln -srf $(STAGING_DIR)/$(LIBAVL_TARGET_LIBRARY) $(STAGING_DIR)/$(LIBAVL_DESTDIR)/libavl.so
	#
