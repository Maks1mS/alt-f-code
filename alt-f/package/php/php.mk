...
PHP_CONF_ENV += CFLAGS="-I$(STAGING_DIR)/compat/usr/include $(TARGET_CFLAGS)" \
...
PHP_CONF_OPT = $(DISABLE_IPV6) \
		...
		--with-openssl-dir=${STAGING_DIR}/compat/usr \
...
ifeq ($(BR2_PACKAGE_PHP_EXT_OPENSSL),y)
	PHP_CONF_OPT += --with-openssl=shared,$(STAGING_DIR)/compat/usr  
	PHP_DEPENDENCIES += openssl-compat
endif
